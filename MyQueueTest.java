...
public class MyQueueTest {
	...
	public void setUp() throws Exception {
		...
		doubleQ.enqueue(22.22);
		doubleQ.enqueue(123.1);
		doubleQ.enqueue(561.11);
	}
	...
	public void testDequeueStudent() {
		try {
			assertTrue("This should have caused an QueueUnderflowException", doubleQ.dequeue() == 22.22);
		} catch (QueueUnderflowException e) {
			assertTrue("This should not caused an QueueUnderflowException", false);
		}
	}
	...
	public void testToStringStudent() {
		assertEquals("22.22123.1561.11", doubleQ.toString());
	}
